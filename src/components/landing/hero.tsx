  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(containerRef.current, { opacity: 1, y: 0, duration: 1 })
        .to(leftRef.current, { opacity: 1, y: 0, duration: 0.8 }, "-=0.5")
          ...
          <div className="relative z-10 px-6 py-12 md:px-10 lg:px-14 md:py-14">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-6 items-center">
              ...
              <div ref={leftRef} className="max-w-xl">
                ...
                <h1 className="text-[32px] md:text-[42px] lg:text-[48px] font-medium text-white mb-4 tracking-[-0.03em] leading-[1.08]">
                  Meet the client handoff portal for MSPs.
                </h1>

                <p className="text-[15px] md:text-[16px] text-white/70 mb-6 leading-[1.6] max-w-md">
